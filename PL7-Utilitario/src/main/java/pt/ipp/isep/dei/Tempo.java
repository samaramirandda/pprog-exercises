...
public class Tempo implements Comparable<Tempo> {
    ...
    /**
     * Hora de saída e de entrada do empregado
     */
    ...
    /**
     * Constrói uma instância de pt.ipp.isep.dei.pt.ipp.isep.dei.Tempo recebendo as horas, minutos e segundos.
     *
    ...
    /**
     * Constrói uma instância de pt.ipp.isep.dei.pt.ipp.isep.dei.Tempo recebendo as horas e os minutos e
    ...
    /**
     * Constrói uma instância de pt.ipp.isep.dei.pt.ipp.isep.dei.Tempo recebendo as horas e assumindo os minutos
    ...
    /**
     * Constrói uma instância de pt.ipp.isep.dei.pt.ipp.isep.dei.Tempo com as horas, minutos e segundos, por
     * omissão.
     */
    public Tempo() {
    ...
    /**
     * Constrói uma instância de pt.ipp.isep.dei.pt.ipp.isep.dei.Tempo com as mesmas caraterísticas do tempo
    ...
    /*
     * Solução alternativa
     * public boolean isMaior(pt.ipp.isep.dei.pt.ipp.isep.dei.Tempo outroTempo){
    ...
    /**
     * Devolve uma instância pt.ipp.isep.dei.pt.ipp.isep.dei.Tempo representativa da diferença entre o tempo e
     * o tempo recebido por parâmetro.
     *
     * @param outroTempo o outro tempo com o qual se compara o tempo para obter
     *                   uma instãncia pt.ipp.isep.dei.pt.ipp.isep.dei.Tempo representativa da diferença entre
     *                   o tempo e o tempo recebido por parâmetro.
     * @return instância pt.ipp.isep.dei.pt.ipp.isep.dei.Tempo representativa da diferença entre o tempo e o
